...
bf::path MempoolStatus::blockchain_path {"~/.blurnetwork/testnet/lmdb"};
string MempoolStatus::deamon_url {"http:://127.0.0.1:21111"};
cryptonote::network_type MempoolStatus::nettype {cryptonote::network_type::TESTNET};
