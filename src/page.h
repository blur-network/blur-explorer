...
struct tx_details
{
    ...
    std::string embedded_hash, ntz_blur_hash, ntz_kmd_hash, ntz_blur_height, ntz_signer_idx;
        ...
        while (i >= start_height)
        {
            ...
            else
            {
                ...
                for(auto it = blk_txs.begin(); it != blk_txs.end(); ++it)
                {
                    ...
                    txd_map.insert({"ntz_signer_idx" , txd.ntz_signer_idx});
...
private:
    ...
    get_tx_json(const transaction& tx, const tx_details& txd)
    {
        ...
        json j_tx {
                ...
                {"ntz_signer_idx"  , txd.ntz_signer_idx},
                   ...
                   uint64_t bc_height = 0)
    {
        ...
        if (tx.version == DPOW_NOTA_TX_VERSION)
        {
            ...
            xmreg::get_embedded_raw_tx_data(tx.extra, txd.embedded_hash, txd.ntz_blur_hash, txd.ntz_kmd_hash, ntz_blur_height, txd.ntz_signer_idx);
